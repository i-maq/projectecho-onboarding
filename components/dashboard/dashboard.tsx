...
// Re-defining our MasterBackground here to make this component self-sufficient
const MasterBackground = () => {
  // This component would contain the JSX and Styles for the particles and pulses
  // For brevity, we assume it's imported or defined as we did in page.tsx
  // In a real app, this would be a shared component.
  return <></>; // Placeholder for brevity, the logic in page.tsx is the source of truth
};
...
export function Dashboard() {
  ...
  const fetchEchoes = async () => { /* ... existing logic ... */ };
  const generateNewPrompt = () => { /* ... existing logic ... */ };
  const saveMemory = async () => { /* ... existing logic ... */ };
  const logout = () => { /* ... existing logic ... */ };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            <div className="glass-panel !bg-white/60 !border-white/20 !shadow-xl">
              ...
              <div className="flex justify-between mt-4">
                ...
                <button onClick={saveMemory} disabled={!currentMemory.trim() || isLoading} className="neumorphic-button-light !bg-purple-600 !text-white !shadow-lg">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
             <div className="glass-panel !bg-white/60 !border-white/20 !shadow-xl h-full">
              <h2 className="text-xl font-bold text-gray-800 flex items-center mb-4">
